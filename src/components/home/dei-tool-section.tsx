      ...
      <div className="container mx-auto px-4">
        <div className="rounded-2xl p-8 md:p-12">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            <div className="lg:w-1/2 text-left">
              ...
              <p className="text-lg text-gray-700 mb-8">
                The Diversity Equity and Inclusion (DEI) section of a grant can be one of the hardest to write. For many quantitative researchers, it often feels forced or disconnected from the rest of the proposal. Still, reviewers increasingly expect thoughtful, evidence-based attention to DEI—and for good reason.
              </p>
              <p className="text-lg text-gray-700 mb-8">
          ...
          <div className="max-w-3xl mx-auto text-center mt-12">
            <h3 className="text-2xl text-jungle-950 font-bold mt-8 mb-4">Important Note</h3>
            <p className="text-lg text-gray-700 mb-8">
